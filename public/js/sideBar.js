...
var collapseBtn = document.querySelector('#colapsar');
...
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    ...
    link.addEventListener("mouseenter", function () {
      body.classList.contains(collapsedClass) && window.matchMedia("(min-width: 768px)").matches ? this.setAttribute("title", this.textContent) : this.removeAttribute("title");
    });
  }
} catch (err) {
  _iterator.e(err);
...
module.exports = __webpack_require__(/*! C:\laragon\www\myGym\resources\js\sideBar.js */"./resources/js/sideBar.js");
